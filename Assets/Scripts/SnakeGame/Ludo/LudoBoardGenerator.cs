...
public class LudoBoardGenerator : MonoBehaviour
{
    ...
    { 
        ...
        Vector2[] path = new Vector2[] 
        {
            ...
            new(0,0),new(-40,0), 
            new(-80,0), new(-120,0),
            new(-160,40), new(-160,80), 
            new(-120,80),new(-80,80),
             new(-40,80), new(0,80),
            new(40,80), new(80,80),
            new(120,120),  new(120,160),
           new(120,200), new(120,240)
            , new(120,280), new(120,320),
            new(160,360), new(200,360),
            new(200,320), new(200,280),
            new(200,240), new(200,200),
            new(200,160),new(200,120)
            , new(240,80), new(280,80),
            new(320,80), new(360,80),
            new(400,80), new(440,80), 
            new(480,40), new(480,0),
            new(440,0), new(400,0),
            new(360,0),  new(320,0), 
           new(280,0),
           new(240,0), new(200,-40),
            new(200,-80), new(200,-120),
            new(200,-160), // Cell_51
            new(200,-200), //Cell_52 (زیر 51)
            new(200,-240), // Cell_53 (زیر 52
            new(160,-240) // Cell_54 (چپ 53)
           // new(160,-200),
            //new(120,-240),
           // new(140,-220)
        };
